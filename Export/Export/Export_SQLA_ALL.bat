...
dtexec /FILE "Export_SQLA_EmployeeCompliance_ALL.dtsx" /MAXCONCURRENT " -1 " /CHECKPOINTING OFF /REPORTING E
echo.
echo SQLA_EmployeeEventTimes
dtexec /FILE "Export_SQLA_EmployeeEventTimes_ALL.dtsx" /MAXCONCURRENT " -1 " /CHECKPOINTING OFF /REPORTING E
echo.
echo SQLA_EventDetails
dtexec /FILE "Export_SQLA_EventDetails_ALL.dtsx" /MAXCONCURRENT " -1 " /CHECKPOINTING OFF /REPORTING E
echo.
echo SQLA_EventDetails_JPVER
dtexec /FILE "Export_SQLA_EventDetails_JPVER_ALL.dtsx" /MAXCONCURRENT " -1 " /CHECKPOINTING OFF /REPORTING E
echo.
echo SQLA_FloorActivity
dtexec /FILE "Export_SQLA_FloorActivity_ALL.dtsx" /MAXCONCURRENT " -1 " /CHECKPOINTING OFF /REPORTING E
...
move SQLA_EmployeeCompliance_ALL.csv SQLA_EmployeeCompliance_ALL_%yyyymmdd_hhmmss%.csv >nul
move SQLA_EmployeeEventTimes_ALL.csv SQLA_EmployeeEventTimes_ALL_%yyyymmdd_hhmmss%.csv >nul
move SQLA_EventDetails_ALL.csv SQLA_EventDetails_ALL_%yyyymmdd_hhmmss%.csv >nul
move SQLA_EventDetails_JPVER_ALL.csv SQLA_EventDetails_JPVER_ALL_%yyyymmdd_hhmmss%.csv >nul
move SQLA_FloorActivity_ALL.csv SQLA_FloorActivity_ALL_%yyyymmdd_hhmmss%.csv >nul
