...
type sp_SSRS_Rpt_RTA_Compliance.sql > sp_SSRS_Rpt_RTA_ALL.sql
type sp_SSRS_Rpt_RTA_Compliance_Employee.sql >> sp_SSRS_Rpt_RTA_ALL.sql
...
type sp_SSRS_Rpt_RTA_EventDetails_ExecSum_Emp.sql >> sp_SSRS_Rpt_RTA_ALL.sql
type sp_SSRS_Rpt_RTA_EventDetails_ExecSum_Emp2.sql >> sp_SSRS_Rpt_RTA_ALL.sql
...
type sp_SSRS_Rpt_RTA_ZoneArea.sql >> sp_SSRS_Rpt_RTA_ALL.sql

type sp_ANI_Users.sql >> sp_SSRS_Rpt_RTA_ALL.sql
type sp_ANI_UserSessions.sql >> sp_SSRS_Rpt_RTA_ALL.sql
