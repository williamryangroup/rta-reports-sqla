...
/****** Object:  StoredProcedure [dbo].[sp_SQLA_Insert_EmployeeAvailableTime_Initial]    Script Date: 07/16/2016 04:27:02 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS (select * from dbo.sysobjects where id = object_id(N'[dbo].[sp_SQLA_Insert_EmployeeAvailableTime_Initial]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	DROP PROCEDURE [sp_SQLA_Insert_EmployeeAvailableTime_Initial]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_SQLA_Insert_EmployeeAvailableTime_Initial]
...
BEGIN
	...
	truncate table SQLA_EmployeeAvailableTime
